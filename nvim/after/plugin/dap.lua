...
dap.defaults.fallback.external_terminal = {
  command = "/home/hjkl/.local/bin/kitty",
  args = { "-e" },
}
...
dap.configurations.go = {
  ...
  },
  {
    ...
    program = "./cmd/lsif-go",
    args = {
      "--project-root=/home/hjkl/sourcegraph/smol_go/",
      "--repository-root=/home/hjkl/sourcegraph/smol_go/",
      "--module-root=/home/hjkl/sourcegraph/smol_go/",
      "--repository-remote=github.com/hjkl/smol_go",
      "--no-animation",
    },
    dlvToolPath = vim.fn.exepath "dlv",
  },
  {
    ...
    program = "./cmd/lsif-go",
    args = {
      "--project-root=/home/hjkl/sourcegraph/sourcegraph.git/main",
      "--repository-root=/home/hjkl/sourcegraph/sourcegraph.git/main",
      "--module-root=/home/hjkl/sourcegraph/sourcegraph.git/main",
      "--no-animation",
    },
    dlvToolPath = vim.fn.exepath "dlv",
  },
